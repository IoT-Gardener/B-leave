...
async def countdown(container: st.delta_generator.DeltaGenerator):
    ...
    while True:
        ...
        time_diff = datetime.strptime("10/09/23 09:00:00", '%m/%d/%y %H:%M:%S') - datetime.now()
...
with st.container():
    ...
    # Add even more text
    st.write("The countdown is on until B-Leave Summit 2023. Check the Whatsapp community for details!")
